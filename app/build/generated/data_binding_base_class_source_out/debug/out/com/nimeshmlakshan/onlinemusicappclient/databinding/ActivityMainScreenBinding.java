...
public final class ActivityMainScreenBinding implements ViewBinding {
  ...
  private ActivityMainScreenBinding(@NonNull RelativeLayout rootView, @NonNull ImageView iconIv,
  ...
  public static ActivityMainScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainScreenBinding((RelativeLayout) rootView, iconIv, loginBtn);
    }
