...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull ImageView logoutBtn,
      @NonNull RecyclerView recyclerviewId, @NonNull TextView subTitleTv, @NonNull TextView titleTv,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, logoutBtn, recyclerviewId, subTitleTv,
          titleTv, toolbarRl);
    }
